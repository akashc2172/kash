...
class PlayerEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.within_branch = FeatureBranchMLP(
            within_dim, hidden_dim // 2, hidden_dim // 4, dropout
        )
...
TIER1_COLUMNS = [
    ...
    'college_ast_total_per40', 'college_tov_total_per40',
    'college_stl_total_per40', 'college_blk_total_per40',

    # Era-normalized anchors (helps mitigate drift)
    'college_three_fg_pct_z', 'college_three_share_z',
...
WITHIN_COLUMNS = [
    ...
    # Efficiency + change (core "star run" signal)
    'final_ws_pps_last10',
    'final_ws_delta_pps_last5_minus_prev5',

    # Timing (when in-season the peak happens)
