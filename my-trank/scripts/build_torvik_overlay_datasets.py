    ...
    with path.open(newline="", encoding="utf-8") as fh:
        ...
        for raw in reader:
            ...
            row = {
                ...
                "ast_pct": _to_float(raw.get("ast", "")),
                "tov_pct": _to_float(raw.get("to", "")),
                "ast_to": _to_float(raw.get("ast_to", "")),
                "oreb_pct": _to_float(raw.get("oreb_rate", "")),
                "dreb_pct": _to_float(raw.get("dreb_rate", "")),
                "ftr": _to_float(raw.get("ftr", "")),
                "blk_pct": _to_float(raw.get("blk", "")),
                "stl_pct": _to_float(raw.get("stl", "")),
